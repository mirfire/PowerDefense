...
public class Config {
	...
	private final static String DB_URL = "127.0.0.1";
	private final static String DB_PORT = "3306";
	private final static String DATABASE = "projet_java";
	public final static String DB_CONNECTION_URL = "jdbc:mysql://" + DB_URL
			+ ":" + DB_PORT + "/" + DATABASE;
